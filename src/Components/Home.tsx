...
export default function Home() {
  return (
    <div className="bg-cover bg-center w-screen min-h-screen select-none font-robo flex flex-col space-y-4 items-center z-10 " style={{backgroundImage: `url(${background})`}}>
      <h1 className="text-4xl font-normal mt-36">Xin chào!</h1>
